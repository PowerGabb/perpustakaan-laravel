...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
       ...
       <div class="d-flex ">
        ...
        <a href="/user-ban-list" class="btn btn-primary btn-sm">List Blokir</a>
       </div>
    </div>
        ...
        <table class="table">
            ...
            <tbody class="table-border-bottom-0">
                ...
                <tr>
                    ...
                    <td>{{ $item->phone }}</td>
                    <td><a href="/user-detail/{{$item->slug}}" class="btn btn-primary btn-sm">Detail</a> | <a href="/users-ban/{{$item->slug}}" class="btn btn-danger btn-sm">Ban</a></td>
                </tr>
                @endforeach
            </tbody>
        </table>
